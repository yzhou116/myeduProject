  ...
  <div id="aCoursesList" class="bg-fa of">
    ...
    <section class="container">
      <section class="path-wrap txtOf hLh30">
        ...
        \
        <a href="#" title class="c-999 fsize14">Course</a>
        \
        <span class="c-333 fsize14">Java Study</span>
      </section>
      <div>
        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            <h2 class="hLh30 txtOf mt15">
              <span class="c-fff fsize24">Java Course</span>
            </h2>
            ...
            <section class="c-attr-mt c-attr-undis">
              <span class="c-fff fsize14"> Yi Zhou&nbsp;&nbsp;&nbsp;</span>
            </section>
            <section class="c-attr-mt of">
              <span class="ml10 vam">
                <em class="icon18 scIcon"></em>
                <a class="c-fff vam" title="收藏" href="#" >Save</a>
              </span>
            </section>
        ...
        <aside class="thr-attr-box">
          <ol class="thr-attr-ol clearfix">
            <li>
              <p>&nbsp;</p>
              <aside>
                <span class="c-fff f-fM">Pruchase</span>
                <br>
            ...
            <li>
              <p>&nbsp;</p>
              <aside>
                <span class="c-fff f-fM">Total</span>
                <br>
            ...
            <div class="i-box">
              <div>
                <section id="c-i-tabTitle" class="c-infor-tabTitle c-tab-title">
                  <a name="c-i" class="current" title="课程详情">Detail</a>
                </section>
              </div>
                        ...
                        <ul>
                          ...
                          <li class="lh-menu-stair">
                            <a href="javascript: void(0)" title="第一章" class="current-1">
                              <em class="lh-menu-i-1 icon18 mr10"></em>Chapter One
                            </a>
                            <ol class="lh-menu-ol" style="display: block;">
                              <li class="lh-menu-second ml30">
                                <a href="#" title>
                                  <span class="fr">
                                    <i class="free-icon vam mr10">Try it Free</i>
                                  </span>
                                  <em class="lh-menu-i-2 icon16 mr5">&nbsp;</em>Lesson 1
                                </a>
                              </li>
                              <li class="lh-menu-second ml30">
                                <a href="#" title class="current-2">
                                  <em class="lh-menu-i-2 icon16 mr5">&nbsp;</em>Lesson 2
                                </a>
                              </li>
                            </ol>
                          </li>
                ...
                <ul style="height: auto;">
                  <li>
                    ...
                    <section class="hLh30 txtOf">
                      <a class="c-333 fsize16 fl" href="#">Jay Chou</a>
                    </section>
                    <section class="hLh20 txtOf">
                      <span class="c-999">University of Toronto</span>
                    </section>
                  </li>
                </ul>
              </section>
