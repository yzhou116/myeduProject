...
export const constantRouterMap = [
  ...
  },
  {
    ...
    name: 'Management',
    meta: { title: 'Management', icon: 'example' },
    children: [
      {
        path: 'table',
        name: 'Teacher Table',
        component: () => import('@/views/edu/teacher/list'),
        meta: { title: 'Teacher Table', icon: 'table' }
      },
      {
        path: 'save',
        name: 'Add Teacher',
    ...
    children: [
      {
        ...
        meta: { title: 'Category Table', icon: 'table' }
      },
      {
        path: 'save',
        name: 'Add Category',
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'CourseInfoEdit',
        component: () => import('@/views/edu/course/info'),
        meta: { title: 'Edit Course', icon: 'tree' },
        hidden:true
      },
      {
        path: 'chapter/:id',
        ...
        meta: { title: 'Edit Chapter', icon: 'tree' },
        hidden:true
      },
      {
        path: 'publish/:id',
        ...
        meta: { title: 'Publish Course', icon: 'tree' },
        hidden:true
      },
    ]
  },
